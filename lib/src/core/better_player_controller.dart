...
class BetterPlayerController {
  ...
  Future<void> addExtSubtitleSource(BetterPlayerSubtitlesSource subtitlesSource) async{
    _betterPlayerSubtitlesSourceList.add(subtitlesSource);
    setupSubtitleSource(subtitlesSource);
  }
